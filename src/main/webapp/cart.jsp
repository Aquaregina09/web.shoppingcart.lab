    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                    ...
                    <form action="./cart" method="POST" >
	                    <tr>
	                        ...
	                        <td>
	                           ...
	                           <input type="hidden" name="price" value="<%= item.getQuantity() %>">
	                           <input type="hidden" name="price" value="<%= item.getTotalPrice() %>">
                ...
                <%
                cart.setGrandTotal(cart.getGrandTotal().add(item.getTotalPrice()));
                }
                %>
            </tbody>
        </table>
        <h3><b>Grand Total: <%= cart.getGrandTotal() %> </b></h3>
        <hr>
        <%
        }
        %>
